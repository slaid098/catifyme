...
{"cat_breed":"<INVENTED fictional breed name in ${langName}, NOT a real breed. Mix two words: one edgy/funny adjective + one weird noun. Memorable, ridiculous, makes you laugh out loud. Examples RU: 'Токсичный капибас','Грибной лорд','Ссаный король','Дерзкий пенёк','Космический бомж','Святой долбоёб'. Examples EN: 'Toxic Capyboss','Mushroom Lord','Sassy Dumpster','Cosmic Bastard','Acid Pope'. Never use real breeds.>","cat_name":"<fun cat name, 1-2 words, in ${langName}>","personality":"<2-3 sentences in ${langName}. This cat is ${vibe}. Read the selfie vibe and match it. Make the user smile and want to share.>","fun_fact":"<one short punchy fact about this person-as-a-cat in ${langName}. Edgy, absurd, memorable. Something that makes you go 'lol what' and want to share. Max 15 words.>","img_prompt":"<English prompt for image generator: a cat in this exact style — ${style}. IMPORTANT: the cat must reflect this person's visible features — hair style and color, face shape, facial hair, glasses, piercings, hats, distinctive features. The cat's expression should match the person's vibe. Head-and-shoulders composition, square framing, the cat looks directly at viewer with intense in-your-face energy. NOT cute, NOT childish, NOT friendly. Bold, aggressive, mindblowing, unforgettable. High detail, sharp focus, professional illustration.>"}
